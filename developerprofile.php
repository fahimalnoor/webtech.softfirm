...
$jsonData= getJSONFromDB("select name,email,phone from logs where uname='".$_COOKIE["developer"]."'");
...
<ul>
  <li><a href="developerhome.php">Your home</a></li>
  <li><a class="active" href="developerprofile.php">Profile</a></li>
