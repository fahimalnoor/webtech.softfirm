...
$jsonData= getJSONFromDB("select name,email,phone from logs where uname='".$_COOKIE["manager"]."'");
...
<ul>
  <li><a href="managerhome.php">Your home</a></li>
  <li><a class="active" href="managerprofile.php">Profile</a></li>
